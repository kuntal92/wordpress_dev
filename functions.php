...
// create "Manage Service" custom post type with "Service Categories" taxonomy
add_action( 'init', 'custom_post_type_manage_services' );
function custom_post_type_manage_services(){
	$labels = array(
	    'name'               => _x( 'Manage Services', 'post type general name' ),
	    'singular_name'      => _x( 'Manage Service', 'post type singular name' ),
	    'menu_name'          => _x( 'Manage Services', 'admin menu' ),
	    'name_admin_bar'     => _x( 'Manage Service', 'add new on admin bar' ),
   	...
   	$args = array(
	    'labels'             => $labels,
	    'description'        => __( 'Description.', 'Add New Services' ),
	    'public'             => true,
	    'publicly_queryable' => true,
	    'show_ui'            => true,
	    'show_in_menu'       => true,
	    'query_var'          => true,
	    'rewrite'            => array( 'slug' => 'manage_services' ),
	    'has_archive'        => true,
	    'hierarchical'       => false,
	    'menu_position'      => 100,
...
add_action( 'init', 'manage_services_taxonomy', 0 );
function manage_services_taxonomy() {
	$labels = array(
	    ...
	    'parent_item_colon' => __( 'Parent Service Categories:' ),
	...
	register_taxonomy( 'service_categories', array( 'manage_services' ), $args );
}
//==============================================================================================================